...
namespace EditedPreload
{
    public class PluginSettings : ISettings
    {
        public PluginSettings()
        {
            ...
            Exiles = new ToggleNode(false);
            Strongboxes = new ToggleNode(false);
            PerandusBoxes = new ToggleNode(false);
            Essence = new ToggleNode(false);
            CorruptedArea = new ToggleNode(false);
            CorruptedTitle = new ToggleNode(false);
